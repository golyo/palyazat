# Üzleti terv – vázlat (belső munkadokumentum)

> **Pályázó:** Szendrei Zsuzsa, őstermelő | **Felhívás:** KAP-RD09a-2-26

---

## 1. A pályázó bemutatása

**Szendrei Zsuzsa** őstermelő, lakhely: Herencsény. Mezőgazdasági tevékenység **2023.05.03.** óta (NAK). Termelés helye: **Cserhátsurány**, Hrsz 60 (kert, szívességi használat).

| Azonosító | Szám |
|-----------|------|
| FELIR | AB4248582 |
| NÉBIH | NEBIH1065438940 |
...
## 4. Piac és értékesítés

_[Kitöltendő: helyi piac, közvetlen értékesítés, mennyiségek kg/év]_

| Termék | Értékesítés |
|--------|-------------|
| Paradicsom, paprika | _[csatorna]_ |
| Saláta, uborka | _[csatorna]_ |
| Málna, szamóca | _[csatorna]_ |
...
| | Ft |
|---|-----|
| Összes elszámolható költség | 11 764 706 |
| Igényelt támogatás (85%) | **10 000 000** |
| Saját rész (~15%) | ~1 764 706 |

**Prioritás:** új sátor → felújítás → öntözés → palánta (utolsó).
...
- Fólia újítás → kevesebb hulladék, hosszabb élettartam  
- Saját palánta → rövidebb szállítási lánc (ha palántaház készül)
